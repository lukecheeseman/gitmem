...
namespace gitmem {
  ...
  GlobalContext::GlobalContext(const trieste::Node &ast, std::unique_ptr<SyncProtocol> protocol):
  ...
  void GlobalContext::print_execution_graph(const std::filesystem::path &output_path) const {
